...
- [Build an ML Pipeline for Short-Term Rental Prices in NYC](#build-an-ml-pipeline-for-short-term-rental-prices-in-nyc)
  ...
  - [License](#license)
  - [Links to projects:](#links-to-projects)
...
## Links to projects:
https://wandb.ai/kate-ge/nyc_airbnb/workspace?workspace=user-kate-ge
https://github.com/KateGE1/build-ml-pipeline-for-short-term-rental-prices
